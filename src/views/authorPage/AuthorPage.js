...
import { AuthorWrap,AuthorDesc,AuthorBook,AuthorBookWrap } from './AuthorPageElements';
            ...
            <AuthorDesc>
                ...
                <div className="m-AuthorDetailsRight">
                    ...
                    <div className="m-AuthorGenre">
                        <Link to='/review/vaasagar/category/Romance'>Romance</Link>
                        <Link to='/review/vaasagar/category/Thriller'>Thriller</Link>
                        <Link to='/review/vaasagar/category/Drama'>Drama</Link>
                        <Link to='/review/vaasagar/category/History'>History</Link>
                    </div>
                    <p id="authorDescPara1">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English.</p>
                    <p id="authorDescPara2">Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using it.</p>
                    <p id="Awards">America Award, Dayton Literary Peace Prize, Vishnupuram Award </p>
                </div>    
            </AuthorDesc>
